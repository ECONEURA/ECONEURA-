  ...
  status: z.enum(['active', 'inactive', 'prospect', 'customer']).default(
  address: z.object({
...
export const ContactSchema = z.object({;
  ...
  status: z.enum(['active', 'inactive', 'bounced']).default(
  tags: z.array(z.string()).default([]),
  orgId: z.string(),
  createdAt: z.string().datetime().optional(),
  updatedAt: z.string().datetime().optional()
...
export const DealSchema = z.object({;
  ...
  stage: z.enum(['lead', 'qualified', 'proposal', 'negotiation', 'closed_won', 'closed_lost']).default(
...
export const InteractionSchema = z.object({;
  ...
  direction: z.enum(['inbound', 
  status: z.enum(['pending', 'completed', 'cancelled']).default(
