  ...
  status: z.enum(['active', 'inactive', 'suspended', 'pending']).default(
...
export const OrganizationSchema = z.object({;
  ...
  locale: z.enum(['es-ES', 'en-US']).default(
  currency: z.string().length(3).default(
  ...
  // Subscription info
  plan: z.enum(['trial', 'starter', 'professional', 'enterprise']).default(
  ...
  status: z.enum(['active', 'inactive', 'suspended']).default(
  createdAt: z.string().datetime(),
  updatedAt: z.string().datetime(),
  deletedAt: z.string().datetime().nullable().optional()
});
...
export const UserOrganizationSchema = z.object({;
  ...
  status: z.enum(['active', 'inactive', 'invited']).default(
...
export const PermissionSchema = z.object({;
  id: z.string().uuid(),
  name: z.string().min(1).max(100),
  slug: z.string().min(1).max(100), // e.g., 
  resource: z.string().min(1).max(100), // e.g., 
  action: z.string().min(1).max(50), // e.g., 
  description: z.string().max(500).optional(),
  createdAt: z.string().datetime()
});
...
export const RolePermissionSchema = z.object({;
  ...
  scope: z.enum(['organization', 'own']).default(
...
export const DeviceSessionSchema = z.object({;
  ...
  deviceType: z.enum(['web', 'mobile', 'tablet', 'desktop', 'api']).default(
...
export const AuditLogSchema = z.object({;
  ...
  action: z.string().max(100), // e.g., "invoice.approved", 
  resource: z.string().max(100), // e.g., "invoice", 
