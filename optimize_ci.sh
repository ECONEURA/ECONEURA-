...
# Opcional: commit
git add .github/workflows/ci.yml WF_EVIDENCE.csv packages/config/agent-routing.json 2>/dev/null || true
git commit -m "CI optimizado: concurrencia, cobertura>=80%, artefactos, NO_DEPLOY" || true