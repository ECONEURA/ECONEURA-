...
test('mountApp dynamic import path (non-test) uses shim createRoot and renders', async () => {
  ...
  ;(globalThis as any).__TEST_CREATE_ROOT = (el: HTMLElement) => ({ render(_v: any) {
  ...
  const mount = mod.mountApp || (mod.default && mod.default.mountApp) || (mod.default && mod.default.default && mod.default.default.mountApp)
