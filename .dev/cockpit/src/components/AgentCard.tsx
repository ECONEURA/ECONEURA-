...
import { ClipboardList, CalendarDays, Megaphone, FileText, Gauge, Activity, FileBarChart2, MessageCircle, ListChecks, Bug, Radar, Inbox, Mail, TrendingUp } from 'lucide-react';
